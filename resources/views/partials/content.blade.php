...
<section class="bg-white py-8 border-gold" style="border-top: white;">
    <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="flex flex-wrap">
            ...
            <div class="w-full sm:w-1/2 p-4">
                <img src="/assets/images/{{ $content->image_one ?? null }}" class="rounded-lg border-gold">
            </div>
        </div>
        <div class="w-full mb-4">
            <div class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
        ...
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
            <div class="w-full sm:w-1/2 p-4 mt-4">
                <img src="/assets/images/{{ $content->image_two ?? null }}" class="rounded-lg border-gold">
            </div>
            <div class="w-full sm:w-1/2 p-4 mt-4">
