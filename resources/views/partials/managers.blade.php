...
@endphp
<section class="bg-white py-8 border-gold" style="border-bottom: white;">
            ...
            @foreach(Manager::all() as $manager)
                <div class="flex flex-col items-center p-8 transition-colors duration-200 transform cursor-pointer group hover:bg-blue-600 rounded-xl">
                    ...
                    <div class="flex items-center justify-start">
                        <a href="mailto:{{$manager->email ?? null}}" class="mx-auto lg:mx-0 hover:underline gradient gold-font font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                            Email me
                        </a>
                    </div>
                </div>
