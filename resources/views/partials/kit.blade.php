<section class="bg-gradient-to-br">
    <div class="container px-6 py-8 mx-auto">
        <h2 class="text-2xl font-semibold text-center antialiased capitalize text-3xl text-white">Our Kit</h2>
        ...
        <div class="grid gap-8 m-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
            ...
            <div class="w-full max-w-xs text-center">
                <img class="object-cover object-center w-full mx-auto rounded-lg" src="/images/goalie.JPG" alt="avatar" />
