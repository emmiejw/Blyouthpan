...
>
    <defs>
        <linearGradient id="gradient1" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" style="stop-color:#2814d8;stop-opacity:1" />
            <stop offset="100%" style="stop-color:#f233b8;stop-opacity:1" />
        </linearGradient>
    </defs>
    <path stroke="none" d="M0 0h24v24H0z"></path>
    <path stroke="url(#gradient1)" transform="scale(-1, 1) translate(-24, 0)"
