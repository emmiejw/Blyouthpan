    ...
    <div class="carousel relative rounded overflow-hidden shadow-xl">
        <div class="carousel-inner relative overflow-hidden w-full">
            ...
            <div class="carousel-item">
                <div class="card">
                    <div class="card-body p-10 m-6 bg-white text-blue-700 rounded-lg edu-vic-wa-nt-beginner">
            ...
            <div class="carousel-item">
                <div class="card">
                    <div class="card-body p-10 m-6 bg-white text-blue-700 rounded-lg sevillana-regular ">
                        @include('partials.left-quote')
            ...
            <div class="carousel-item">
                <div class="card">
                    <div class="card-body p-10 m-6 bg-white text-blue-700 rounded-lg caveat">
                        @include('partials.left-quote')
