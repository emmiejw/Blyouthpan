        ...
        <div class="md:p-3">
            ...
            <form method="post" action="{{ route('managers.update', $manager->id) }}" enctype="multipart/form-data" class="md:w-5/6">
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        <input value="{{ $manager->email }}" class="bg-gray-100 appearance-none border-2 border-gray-100 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="role" name="role" type="text">
                    </div>
                </div>
                <div class="md:flex md:items-center mb-6">
                    <div class="md:w-1/3">
