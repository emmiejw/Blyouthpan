    ...
    <div class="w-5/6 m-auto flex flex-col bg-white border shadow-sm rounded-xl dark:bg-grey-500 dark:shadow-neutral-700/70">
        <div class="md:p-3">
            <div class="card-header">
                <h2 class="text-2xl font-semibold leading-tight text-center mb-4">Add a Manager or Coach</h2>
            </div>
            <form method="post" action="{{ route('managers.store') }}" enctype="multipart/form-data" class="md:w-5/6">
                @csrf
